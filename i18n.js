...
"Pour les prochaines améliorations, je prévois d'ajouter des notifications pour informer les utilisateurs de l'ouverture de leurs centres préférés et de collecter des informations supplémentaires, telles que les possibilités de location et les prix d'entrée. Ensuite, si le projet se développe bien, je souhaiterais offrir l'application sous forme d'application mobile en transitant le code sur React Native."],
  cv: "Pour voir mon CV.",
  storyTitle: "Ma petite histoire",
  storyText: "J'ai toujours aimé la technologie depuis mon plus jeune âge. J'ai commencé par bricoler sur l'ordinateur familial, ce qui m'a parfois conduit à des accidents involontaires. Mais comme pour le codage, c'est souvent en cassant les choses que l'on apprend le mieux. Comme je le dis souvent, même Bill Gates a été novice un jour ! Ma fascination précoce pour la technologie m'a finalement poussé à étudier la biologie afin de mieux comprendre le monde naturel et de m'y connecter. Cette passion pour le plein air m'a conduit à travailler comme guide de plein air, créant des expériences significatives pour les clients. Cependant, mon amour pour la technologie est resté fort, et je suis naturellement devenu la personne à qui s'adresser en matière de technologie partout où j'allais. Cette passion a culminé dans ma décision de plonger pleinement dans le monde de la technologie, ce qui m'a amené à suivre un cours d'ingénierie FullStack à l'Université Concordia.",
  developerTitle: "En tant que développeur",
  developerEthos: "Mon éthique de codage tourne autour de la clarté et de la réutilisation. Je travaille fort pour m'assurer que mon code est non seulement fonctionnel, mais aussi facilement réutilisable par moi et mes collaborateurs. Je m'efforce de trouver le meilleur équilibre entre fonctionnalité et maintenabilité, en m'assurant que mon code est à la fois efficace et adaptable.",
  personTitle: "En tant que personne",
  personTraits: "Je suis profondément empathique et j'aime relever les défis. J'aborde les problèmes avec un esprit créatif, en les décomposant et en trouvant des solutions innovantes. Ma passion pour l'apprentissage - que ce soit auprès des autres ou par la découverte personnelle - alimente ma créativité et m'aide à naviguer dans des situations complexes. La curiosité est mon compagnon de tous les instants, et je suis toujours prêt à me dépasser.",
  colleagueTitle: "En tant que collègue",
  colleagueDescription: "Je suis dédié à soutenir mon équipe et à favoriser un environnement collaboratif. Je suis toujours prêt à donner un coup de main, à aider dans les tâches ou à maintenir une bonne ambiance. Mon expérience en tant que guide et formateur me permet de décomposer des concepts complexes en parties compréhensibles, ce qui fait de moi un collègue fiable et accessible. Je suis toujours partant pour un café ou une bière après le travail. En tant que passionné de plein air, je suis votre référence pour votre prochaine aventure, et je peux cuisiner comme un chef dans la cuisine comme en forêt !",
  developerMotivation: "Même en tant que nouveau développeur, je m'efforce de rendre mon travail aussi qualitatif et impactant que possible. Je suis déterminé à atteindre l'excellence et je suis impatient de me connecter et de collaborer avec d'autres personnes partageant cette passion."
        }
      }
    }
  });
